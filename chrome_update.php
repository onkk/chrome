...
function getPosts() {
  $platforms = array(
    'win' => array('x64'),# array('x86', 'x64', 'arm64'),
    'mac' => array('x64')
  );
  $channels = array('stable');# array('stable', 'beta', 'dev', 'canary');
  $vers = array(
    'win' => '10.0.26100.1742',# 'win' => '10.0',
    'mac' => '46.0.2490.86'
  );
  $appids = array(
  ...
  $aps = array(
    'win_stable_x86' => 'x86-stable',# 'win_stable_x86' => '-multi-chrome',
    'win_stable_x64' => 'x64-stable',# 'win_stable_x64' => 'x64-stable-multi-chrome',
    'win_stable_arm64' => 'arm64-stable',# +
    'win_beta_x86' => '1.1-beta-arch_x86',# 'win_beta_x86' => '1.1-beta',
    'win_beta_x64' => '1.1-beta-arch_x64',# 'win_beta_x64' => 'x64-beta-multi-chrome',
    'win_beta_arm64' => '1.1-beta-arch_arm64',# +
    'win_dev_x86' => '2.0-dev-arch_x86',# 'win_dev_x86' => '2.0-dev',
    'win_dev_x64' => '2.0-dev-arch_x64',# 'win_dev_x64' => 'x64-dev-multi-chrome',
    'win_dev_arm64' => '2.0-dev-arch_arm64',# +
    'win_canary_x86' => 'x86-canary',# 'win_canary_x86' => '',
    'win_canary_x64' => 'x64-canary',# 'win_canary_x64' => 'x64-canary',
    'win_canary_arm64' => 'arm64-canary',# +
...
echo json_encode($res, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT);# echo json_encode($res);# Replacing "\/" with "/",Print
